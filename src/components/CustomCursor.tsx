...
export function CustomCursor() {
  ...
  useEffect(() => {
    ...
    function tick() {
      ...
      if (dot) {
        dot.style.transform = `translate(${pos.current.x - 4}px,${pos.current.y - 4}px) scale(${clicking.current ? 0.4 : 1})`;
      }
      ...
      if (r) {
        ...
        r.style.borderColor = hovered.current ? "rgba(201,168,76,0.9)" : "rgba(201,168,76,0.38)";
        r.style.backgroundColor = hovered.current ? "rgba(201,168,76,0.06)" : "transparent";
      }
  ...
  return (
    <>
      <div ref={dotRef} aria-hidden="true" style={{
        ...
        background: "#C9A84C",
        boxShadow: "0 0 10px rgba(201,168,76,0.9), 0 0 24px rgba(201,168,76,0.4)",
      ...
      <div ref={ringRef} aria-hidden="true" style={{
        ...
        borderRadius: "50%", pointerEvents: "none", zIndex: 99998, willChange: "transform",
        transition: "width 0.22s cubic-bezier(0.34,1.56,0.64,1), height 0.22s cubic-bezier(0.34,1.56,0.64,1), border-color 0.2s ease, background-color 0.2s ease",
      }} />
    </>
  );
}
